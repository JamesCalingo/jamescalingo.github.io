    ...
    <div id="about" className="slide">
      <div className="card">
        ...
        <div id="bio" className="card-body">
          ...
          <p>
            And that's basically me in a nutshell. If you want to know more, you can use the links in the sidebar to the left (or above if you're on mobile) to check out my <a href="https://linkedin.com/in/james-calingo">LinkedIn</a> and <a href="https://github.com/JamesCalingo">GitHub</a>
          </p>

          <p>I've also been attending sporting events for a while and writing about them, which you can find on my <a href="https://sportventures.blog">sport-focused blog</a>.</p>
        </div>
      </div>
    </div>
  );
